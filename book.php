...
<body>
    ...
    <section class="services services-page spad">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <span>Want to design your sapce?</span>
                        <h2>Book Now!</h2>
                        <p>kipusa Home is one of the leading interior and exterior design firms in East Africa. With our dedicated,artistic team, we guarantee perfect rsult leaving you with the satisfaction you desire.</p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <?php
            echo "the php script is supposed to go here."
            ?>
            </div>
